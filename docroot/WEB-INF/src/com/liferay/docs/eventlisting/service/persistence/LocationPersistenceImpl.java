...
public class LocationPersistenceImpl extends BasePersistenceImpl<Location>
	...
	private static final String _FILTER_SQL_SELECT_LOCATION_WHERE = "SELECT DISTINCT {location.*} FROM Location location WHERE ";
	private static final String _FILTER_SQL_SELECT_LOCATION_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {Location.*} FROM (SELECT DISTINCT location.locationId FROM Location location WHERE ";
	private static final String _FILTER_SQL_SELECT_LOCATION_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN Location ON TEMP_TABLE.locationId = Location.locationId";
	private static final String _FILTER_SQL_COUNT_LOCATION_WHERE = "SELECT COUNT(DISTINCT location.locationId) AS COUNT_VALUE FROM Location location WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "location";
	private static final String _FILTER_ENTITY_TABLE = "Location";
	private static final String _ORDER_BY_ENTITY_ALIAS = "location.";
	private static final String _ORDER_BY_ENTITY_TABLE = "Location.";
