...
public class EventPersistenceImpl extends BasePersistenceImpl<Event>
	...
	private static final String _FILTER_SQL_SELECT_EVENT_WHERE = "SELECT DISTINCT {event.*} FROM Event event WHERE ";
	private static final String _FILTER_SQL_SELECT_EVENT_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {Event.*} FROM (SELECT DISTINCT event.eventId FROM Event event WHERE ";
	private static final String _FILTER_SQL_SELECT_EVENT_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN Event ON TEMP_TABLE.eventId = Event.eventId";
	private static final String _FILTER_SQL_COUNT_EVENT_WHERE = "SELECT COUNT(DISTINCT event.eventId) AS COUNT_VALUE FROM Event event WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "event";
	private static final String _FILTER_ENTITY_TABLE = "Event";
	private static final String _ORDER_BY_ENTITY_ALIAS = "event.";
	private static final String _ORDER_BY_ENTITY_TABLE = "Event.";
