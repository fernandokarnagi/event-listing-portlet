...
public class EventModelImpl extends BaseModelImpl<Event> implements EventModel {
	...
	public static final String TABLE_SQL_CREATE = "create table Event (eventId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,description VARCHAR(75) null,date_ DATE null,locationId LONG)";
